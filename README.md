...
Before we needed data to test the machine learning algorithm, we first used <a href="http://research.cs.wisc.edu/bullying/data.html">code from the University of Wisconsin - Madison, with data they gave to train the SVM.</a>
